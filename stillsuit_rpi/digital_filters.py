...
from collections import deque               # deque =  "double ended queue", data structure to optimised pulling and pushing data from both ends: used as a stack (Last in, First out) or a queue (First in, First out)
